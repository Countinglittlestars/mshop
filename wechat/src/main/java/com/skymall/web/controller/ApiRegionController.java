...
import com.skymall.utils.RegionCacheUtil;
import com.skymall.utils.StringUtils;
import com.skymall.vo.Response;
import com.skymall.vo.wechat.RegionVo;
...
@RestController
@RequestMapping("/mshop/wc/region")
public class ApiRegionController {
    ...
    public Object info(Integer regionId) {
        ...
        return Response.success(new RegionVo(regionEntity));
    }
