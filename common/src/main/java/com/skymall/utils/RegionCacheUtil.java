...
import com.skymall.dao.SysRegionMapper;
...
public class RegionCacheUtil {
    ...
    public static List<SysRegionEntity> sysRegionEntityList = null;
...
//    }
    ...
    public static void judge(){
        SysRegionMapper regionMapper = SpringContextUtils.getBean(SysRegionMapper.class);
        if(sysRegionEntityList == null){
            sysRegionEntityList = regionMapper.queryList(new HashMap<String, Object>());
        }
    }
